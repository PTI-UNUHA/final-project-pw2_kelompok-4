            ...
            <div className="min-h-screen bg-[#f7faf8] flex items-center justify-center p-6">
                <div className="bg-white p-12 rounded-[50px] shadow-xl text-center max-w-md border border-green-50">
                    ...
                    <p className="text-gray-500 mb-8 font-medium">
                        Kamu telah terdaftar di event ini. Silakan cek email atau menu Profil untuk melihat tiketmu.
                    </p>
                    <Link href="/event">
                    ...
                    <form onSubmit={handleRegister} className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full p-4 bg-gray-50 border border-gray-100 rounded-2xl outline-none focus:border-green-500 transition"
                            />
                        </div>
                        ...
                        <div className="p-6 bg-green-50 rounded-3xl border border-green-100">
                            ...
                            <p className="text-xs text-green-700 mt-1">
                                Pastikan data yang kamu masukkan sudah benar. Link grup WhatsApp akan muncul setelah
                        ...
                        <button
                            type="submit"
                            className="w-full bg-[#16a34a] text-white py-5 rounded-[25px] font-black text-lg hover:bg-[#15803d] transition shadow-lg mt-4"
                        >
