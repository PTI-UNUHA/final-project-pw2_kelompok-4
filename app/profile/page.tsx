                    ...
                    <div className="bg-[#1a3a2a] p-8 md:p-12 flex flex-col md:flex-row items-center gap-8 relative overflow-hidden">
                        ...
                        <div className="md:ml-auto flex gap-3">
                            <button
                                ...
                                className="bg-white/10 hover:bg-red-500 text-white px-6 py-3 rounded-2xl font-bold text-sm transition border border-white/20"
                            >
                                Logout
                            </button>
                        </div>
                ...
                <div className="space-y-4">
                    ...
                    {myEvents.length === 0 ? (
                        <div className="bg-white p-12 rounded-[40px] text-center border-2 border-dashed border-gray-200">
                            ...
                            <Link href="/event">
                                <button className="mt-4 text-green-600 font-black hover:underline">
                                    Cari Event Sekarang →
                                </button>
                            </Link>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {myEvents.map((event) => (
                                <div
                                    key={event.id}
                                    className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 flex items-center justify-between group hover:border-green-300 transition-all"
                                >
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-gray-800 group-hover:text-green-700 transition">
                                                {event.title}
                                            </h4>
