...
export default function BerandaPage() {
  const popularEvents = [
    { id: "1", type: "Workshop", title: "Workshop: Digital Marketing", date: "25 Mei 2024", univ: "Universitas Nurul Huda", price: "Gratis", color: "bg-[#00a651]" },
    { id: "2", type: "Webinar", title: "Webinar: Startup Mahasiswa", date: "31 Mei 2024", univ: "Online", price: "Gratis", color: "bg-[#008d7d]" },
    { id: "3", type: "Seminar", title: "Seminar Kewirausahaan", date: "7 Juni 2024", univ: "Universitas Nurul Huda", price: "Gratis", color: "bg-[#005a32]" },
    { id: "4", type: "Talkshow", title: "Talkshow Karir Sukses", date: "18 Jun 2024", univ: "Online", price: "Gratis", color: "bg-[#00a651]" },
  ];
    ...
    <main className="min-h-screen bg-white font-sans text-gray-800">
      ...
      <section className="max-w-7xl mx-auto px-6 mb-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {popularEvents.map((event) => (
            <div key={event.id} className="bg-white rounded-[35px] overflow-hidden border border-gray-100 shadow-sm hover:shadow-2xl transition-all duration-300 group">
              <div className={`${event.color} h-44 p-6 relative text-white flex flex-col justify-between`}>
                 ...
                 <h4 className="text-lg font-black leading-tight group-hover:scale-105 transition">{event.title}</h4>
              </div>
              <div className="p-6">
      ...
      <footer className="bg-[#0b1b11] text-white pt-20 pb-10">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-16 pb-16 border-b border-white/5">
          ...
          <div>
            <h4 className="font-black text-lg mb-8 uppercase tracking-widest text-green-500 font-bold">Navigasi</h4>
          ...
          <div>
            <h4 className="font-black text-lg mb-8 uppercase tracking-widest text-green-500 font-bold">Layanan</h4>
            <ul className="space-y-4 text-gray-400 text-sm font-bold">
              <li><Link href="/about" className="hover:text-white transition">Info Kampus</Link></li>
              <li><Link href="/event" className="hover:text-white transition">Upload Event</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="font-black text-lg mb-8 uppercase tracking-widest text-green-500 font-bold">Kontak</h4>
